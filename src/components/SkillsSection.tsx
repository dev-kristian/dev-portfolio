...
import { SiFirebase, SiRedis, SiMui, SiChakraui, SiOpenai, SiFlask } from "react-icons/si";
...
const SkillsSection: React.FC = () => {
  const [skills] = useState<Skill[]>([
    ...
    { name: 'TypeScript', icon: <TbBrandTypescript />, proficiency: 60, description: 'Strong typing skills, improving code quality and maintainability.', category: 'frontend' },
    ...
    { name: 'Redis', icon: <SiRedis />, proficiency: 60, description: 'Experienced in using Redis for caching and as a message broker.', category: 'database' },
    ...
    { name: 'OpenAI API', icon: <SiOpenai />, proficiency: 70, description: 'Familiar with OpenAI API for natural language processing and AI-powered applications.', category: 'tools' },
  ]);
